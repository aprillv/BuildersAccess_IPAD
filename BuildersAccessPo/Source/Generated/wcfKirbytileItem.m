/*
	wcfKirbytileItem.h
	The implementation of properties and methods for the wcfKirbytileItem object.
	Generated by SudzC.com
*/
#import "wcfKirbytileItem.h"

@implementation wcfKirbytileItem
	...
	+ (wcfKirbytileItem*) newWithNode: (CXMLNode*) node
	{
		...
		return (wcfKirbytileItem*)[[[wcfKirbytileItem alloc] initWithNode: node] autorelease];
	}
	...
	{
		return [self serialize: @"KirbytileItem"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[wcfKirbytileItem class]]) {
