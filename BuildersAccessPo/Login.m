...
//    y=y+21+x;
//    
//    usernameField=[[UITextField alloc]initWithFrame:CGRectMake(xx, y, 544, 31)];
...
//    y=y+21+x;
//    
//    passwordField=[[UITextField alloc]initWithFrame:CGRectMake(xx, y, 544, 31)];
...
//    
//    
//    lbl =[[UILabel alloc]initWithFrame:CGRectMake(xx, y, controlwidth, 36)];
...
//    [sv addSubview: lbl];
//    
//    lbl =[[UILabel alloc]initWithFrame:CGRectMake(xx+8, y+8, 120, 21)];
//    lbl.text=@"Remember Me";
//    [sv addSubview:lbl];
//    
//    //    switchView= [[UISwitch alloc] initWithFrame:CGRectMake(xx+180, y+4, 100.0f, 28.0f)];
//    //    switchView.on = NO;
...
//    //    y=y+70+x;
//    switchView= [[UISwitch alloc] initWithFrame:CGRectMake(xx+460, y+4, 100.0f, 28.0f)];
//    switchView.on = NO;
//    [sv addSubview:switchView];
//    [switchView addTarget:self action:@selector(CheckboxClicked:) forControlEvents:UIControlEventValueChanged];
//    y=y+70+x;
...
//    [btn1 setFrame:CGRectMake(xx, y, 544, 44)];
