...
-(IBAction)goBack:(id)sender
{
    ...
    if (netStatus ==NotReachable) {
        ...
        [service xisupdate_ipad:self action:@selector(xisupdate_iphoneHandler11:) version:version];
    }
}
...
-(IBAction)gohome:(id)sender{
    ...
    if (netStatus ==NotReachable) {
        ...
        [UIApplication sharedApplication].networkActivityIndicatorVisible = YES;
        [service xisupdate_ipad:self action:@selector(xisupdate_iphoneHandler12:) version:version];
    }
}
