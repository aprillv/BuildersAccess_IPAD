...
@interface bustoutcials ()<cntlistfirstCellDelegate>
...
//    uv.backgroundColor=[UIColor whiteColor];
    ...
    if (ciatbview ==nil) {
        ...
        int dh =([result count])*44+44;
        if (dh>dheight-44) {
            dh=dheight-44;
        }
        ciatbview=[[UITableView alloc] initWithFrame:CGRectMake(0, 0, dwidth, dh)];
        
        //        ciatbview=[[UITableView alloc] initWithFrame:CGRectMake(10, 10, dwidth-20, dheight-44)];
...
//    uv.backgroundColor=[UIColor whiteColor];
//    
//    uv.contentSize=CGSizeMake(dwidth,self.uw.frame.size.height+1);
