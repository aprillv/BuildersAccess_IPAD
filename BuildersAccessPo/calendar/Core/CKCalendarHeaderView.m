...
//     CGRect backFrame = CGRectMake(0, 0, titleLabelHeight, titleLabelHeight);
...
//    [loginButton setBackgroundImage:[_forwardButton.polyImage stretchableImageWithLeftCapWidth:10.0 topCapHeight:0.0] forState:UIControlStateNormal];
//    loginButton.layer.cornerRadius = 5.0;
////    [loginButton setTitle:@"fsdfsdf" forState:UIControlStateNormal];
//    [loginButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    
//    loginButton.frame=backFrame;
